package net.hexagonelle.hexsappletrees;

import com.mojang.logging.LogUtils;
import net.hexagonelle.hexsappletrees.items.ModCreativeTabs;
...
@Mod(HexsAppleTrees.MODID)
public class HexsAppleTrees
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "hexsappletrees";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public HexsAppleTrees()
    {
